      ...
      if (chat.welcome) {
        ...
        for (let user of participants) {
          ...
          try {
            ...
            pp = 'https://files.catbox.moe/tw0lkw.jpeg' // Assign default image URL
            ppgp = 'https://files.catbox.moe/tw0lkw.jpeg' // Assign default image URL
          } finally {
            ...
            let welcomeApiUrl = `https://files.catbox.moe/tw0lkw.jpeg${encodeURIComponent(
              ...
              'https://files.catbox.moe/tw0lkw.jpeg'
            )}`
      ...
      if (chat.welcome) {
        ...
        for (let user of participants) {
          ...
          try {
            ...
            let leaveApiUrl = `https://files.catbox.moe/tw0lkw.jpeg${encodeURIComponent(
              await this.getName(user)
            )}&guildName=${encodeURIComponent(await this.getName(id))}&guildIcon=${encodeURIComponent(
              ppgp
            )}&memberCount=${encodeURIComponent(
