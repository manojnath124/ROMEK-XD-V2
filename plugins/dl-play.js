...
const handler = async (m, {conn, command, args, text, usedPrefix}) => {
  ...
  try {
   ...
   if (command === 'play') {
    ...
    const texto1 = `*◉—⌈🎶ROMEK-XD-V2 (music downloader)🎶⌋—◉*\n❏ 📌 *𝗧𝗶𝘁𝗹𝗲:* ${yt_play[0].title}
      ...
      try {
        ...
        try {
          ...
          try {
            ...
            await conn.reply(m.chat, '*[👑] ROMEK-XD-V2 is extracting your audio please be patient *', m);
          }
        }
      }
    }
      ...
      try {
        ...
        try {
          ...
          try {
            ...
            await conn.reply(m.chat, '*[👑]ROMEK-XD-V2-BOT is extracting your audio please be patient *', m);
          }
        }
      }
    }
  } catch {
    throw '*[👑]ROMEK-XD-V2 is extracting your audio please be patient *';
  }
};
